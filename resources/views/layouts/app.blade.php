...
<body class="bg-gray-100" x-data="{ mobileMenuOpen: false }">
    ...
    <div class="min-h-screen md:flex">
        ...
        <aside class="hidden md:block md:w-64 fixed left-0 top-0 h-screen bg-white shadow-lg p-4 transition-all duration-300 z-50">
            <div class="flex flex-col h-full">
                <!-- Logo -->
                <h2 class="text-2xl font-bold text-gray-800 mb-8 px-2">Devstagram</h2>
                ...
                <nav class="flex-1 space-y-2">
                    ...
                    <a href="{{ route('posts.create')}}" 
                       class="flex items-center gap-3 px-4 py-3 rounded-lg bg-indigo-100 text-indigo-700">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
